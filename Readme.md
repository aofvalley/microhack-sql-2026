...
Service (DMS), Managed Instance Link, and Log Replay Service (LRS). Sample databases changed to
public AdventureWorks2019 and WideWorldImporters. Source SQL Server versions are 2019/2022.
